...
function kategorie()
{
        $kategorien="<select name=\"kategorie\" style=\" width:200px; height:40px; background-color:#FFFFFF; border-width:0; font-size: 16px; color:#000000; border-radius: 3px 3px 3px 3px;\">
          ...
          <option value=\"Trockenobst\">Trockenbst</option>
...
function popup ($inhalt,$adresse)
{
$seite="<a target=\"popup\"onclick=\"window.open('','popup','width=580,height=360,scrollbars=yes,toolbar=no,status=no,resizable=yes,menubar=no,location=no,directories=no,top=10,left=10')\"href=\"$adresse\"><font style=\" color: #000000; \">&nbsp;$inhalt</a>
";
...
function popup_hilfe ($adresse_hilfe)
{
$hilfe_seite="<a target=\"popup\"onclick=\"window.open('','popup','width=580,height=360,scrollbars=yes,toolbar=no,status=no,resizable=yes,menubar=no,location=no,directories=no,top=10,left=10')\"href=\"$adresse_hilfe\"><font style=\" color: red; \">&nbsp;H I L F E</a>
";
