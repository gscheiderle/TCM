...
?>
 ...
 <?php  echo "<input type=\"checkbox\" name=\"$beginn_rechts\" value=\"1\">
        </td>
        
        <td><input type=\"text\" name=\"$menge_rechts\" size=\"30\" value=\"".$_POST[$menge_rechts]."\" style=\"color:#000000; background-color:rgb(255,230,230); border-width:2; border-color:#cccccc; border-style:none;\">";?>
 <?php  $wechsel_r=wechsel($_POST[$rechts],$rechts,$_POST[$veri_rechts]);
        echo "<input type=\"text\" name=\"$rechts\" size=\"45\" tabindex=\"$rechts\" value=\"";?><?php neuladen($_POST[$rechts],$wechsel_r);echo "\" style=\"color:#000000; background-color:rgb(255,230,230); border-width:2; border-color:#cccccc; border-style:none;\">

        </td>
        
        <td>
        <input type=\"submit\" name=\"veri_$rechts\" value=\"veri$rechts\">
        </td>
