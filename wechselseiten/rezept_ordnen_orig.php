...
echo datenfelder($anzahl, $temp_tab_name);   
...
$update_1=mysql_query("update $temp_tab_name 
set 
menge = '$_POST[$menge]',
...
$product=htmlentities("$result_2[product]");
$menge=htmlentities("$result_2[menge]");
$tip=htmlentities("$result_2[tip]");
...
if (($_POST['rezept_name'] != "") && ($_SESSION['einlass'] == "du_darfst_rein") && ($_POST['rezept_kategorie'] != "Kategorie")) {
$center_speichern=mysql_query("insert into center (verfasser,kategorie,name,code,zeitstempel) values ('$_SESSION[nickname]','$_POST[rezept_kategorie]','$_POST[rezept_name]','$mein_projekt','$datum')");
}
